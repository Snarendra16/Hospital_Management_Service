...
const handleRegister = async () => {
  try {
    const response = await fetch('https://hospital-management-service-1.onrender.com/auth/register-doctor', {
        method: 'POST',
      ...
      <div class="col-md-5">
        <div class="card shadow-lg border-0">
          <div class="card-body p-5">
            <h3 class="text-center mb-4 text-info">Doctor Registration</h3>
            ...
            <form @submit.prevent="handleRegister">
              ...
              <div class="mb-4">
                <label class="form-label text-uppercase small fw-bold text-muted">Specialization</label>
                <input v-model="specialization" type="text" class="form-control form-control-lg" placeholder="e.g. Cardiology" required>
              </div>
              <button type="submit" class="btn btn-info w-100 btn-lg mb-3 text-white">Join as Doctor</button>
            </form>
